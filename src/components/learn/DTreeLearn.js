  ...
  render() {
    return (
      <div>
        ...
        <p>
          We need to build a decision tree node by node, so how do we determine
          which feature becomes which node?
        </p>
        <p>
          At each Node, we want to have the highest “gain ratio”, which is
          basically the amount of distinctness that we can have by splitting at
          that feature. To calculate gain, we have to calculate the “impurity”
          of the current overall dataset and the “impurity” of each of the
          feature in the dataset. Impurity is basically a measure of how pure
          the dataset is by the class label
        </p>
        <p>
        ...
        <p>
          ...
          that correspond to the class label that we currently referring to, and
          calculate entropy like that
        </p>
        <p>
        ...
        <Image src={Split} />
        <p>
          We also need what is called the “split info” which is a measure of how
          many “branches” can be split on that feature, or how many distinct
          values the feature has. This can be calculated like this.
        </p>
        <Image src={SplitInfo} />
        <p>
